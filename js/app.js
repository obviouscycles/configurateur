...
function selectCadreTaille(value) {
  if (value === '__sur_mesure__') {
    ...
    // "Je ne sais pas encore" — fonctionnellement identique à "rien de choisi" (la
    // taille reste à déterminer), mais gardé comme valeur dédiée pour que le menu
    // continue d'afficher cette option précise au prochain rendu, plutôt que de
    // retomber sur le premier élément de la liste par défaut du navigateur.
    v2Parcours = 'standard';
    delete selSize.taille; delete selSizeSource.taille;
  } else {
    v2Parcours = 'standard';
